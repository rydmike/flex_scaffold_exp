...
/// An AppBar data class and Material [AppBar] creation utility used by the
/// by the [FlexScaffold] scaffold. Can also be used without [FlexScaffold].
///
...
/// different app bars, it creates the actual app bar(s) with
/// [FlexAppBar.toAppBar].
///
/// If the [FlexAppBar] is used outside of [FlexScaffold] and the method
/// [toAppBar] is called, the resulting AppBar will be identical to one made
/// with [AppBar]. There is obviously no need or point in using the
...
///  * [IconButton], used with [actions] to show buttons on the app bar.
...
class FlexAppBar {
  ...
  /// no effect.
  ///
  /// The parameter has no effect when [FlexAppBar] is consumed by
  /// [FlexScaffold]. It will create leading and action widget as needed based
  /// on its current navigation. In effect one could say that it always uses
  /// a form of advanced [automaticallyImplyLeading] and imply last actions
  /// widget.
