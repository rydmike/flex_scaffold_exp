...
class SurfaceModeToggleButtons extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // TODO(rydmike): Fix this direct constant.
    final bool showAllModes = media.size.width > 600;
    final ColorScheme scheme = Theme.of(context).colorScheme;

    final List<bool> isSelected = <bool>[
      // Only have this blend option if show all set, not enough room.
      if (showAllModes) mode == FlexSurfaceMode.level,
    ...
    final List<FlexSurfaceMode> option = <FlexSurfaceMode>[
      // Only have this blend option if show all set, not enough room.
      if (showAllModes) FlexSurfaceMode.level,
...
class SurfaceModePopupMenu extends StatelessWidget {
  ...
  String _explainMode(final FlexSurfaceMode mode) {
    switch (mode) {
  ...
  Widget build(BuildContext context) {
    ...
    final String styleName = _explainMode(FlexSurfaceMode.values[index]);
