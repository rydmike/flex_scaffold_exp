...
class AppTheme {
          ...
          side: MaterialStateProperty.resolveWith<BorderSide?>(
            (Set<MaterialState> states) {
              ...
              if (states.contains(MaterialState.error)) {
                return BorderSide(
                  color: scheme.error,
                  width: Sizes.outlineThickness,
                );
              }
              return BorderSide(
                  color: scheme.primary, width: Sizes.outlineThickness);
            },
          ),
        ),
      );
  ...
  static ToggleButtonsThemeData toggleButtonsTheme(
      ...
      ToggleButtonsThemeData(
        ...
        borderWidth: Sizes.outlineThickness,
        borderColor: colorScheme.primary,
        selectedBorderColor: colorScheme.primary,
        borderRadius: BorderRadius.circular(Sizes.buttonRadius),
        constraints: const BoxConstraints(
            minWidth: Sizes.buttonRadius, minHeight: Sizes.buttonRadius),
      );
