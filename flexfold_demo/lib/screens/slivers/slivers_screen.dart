...
import '../settings/other_settings/sidebar_belongs_to_body_switch.dart';
import '../settings/visibility/hide_bottom_bar_on_scroll_switch.dart';
import '../settings/visibility/show_bottom_bar_when_menu_shown_switch.dart';
import 'sliver_app_bar_demo.dart';

class SliversScreen extends ConsumerStatefulWidget {
  const SliversScreen({super.key});

  static const String route = AppRoutes.slivers;

  @override
  ConsumerState<SliversScreen> createState() => _SliversScreenState();
}

class _SliversScreenState extends ConsumerState<SliversScreen> {
            ...
            slivers: <Widget>[
              ...
              SliverPadding(
                padding: EdgeInsetsDirectional.fromSTEB(breakpoint.gutters,
                    AppInsets.l + topPadding, breakpoint.gutters, 0),
                sliver: SliverList(
                    ...
                    <Widget>[
                      ...
                      PageIntro(
                        introTop: Text(
                          ...
                          'width'
                          '(${AppInsets.maxBodyWidth.toStringAsFixed(0)}dp '
                        ...
                        imageAssets:
                            AppImages.route[SliversScreen.route]!.toList(),
                      ),
