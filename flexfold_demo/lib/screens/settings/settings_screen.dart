...
import 'app_bar/settings_app_bar.dart';
import 'application_settings/settings_application.dart';
import 'bottom_bar/settings_bottom_bar.dart';
import 'breakpoints/settings_breakpoints.dart';
import 'menu_controls/menu_control_settings.dart';
import 'menu_style/settings_menu.dart';
import 'other_settings/settings_other.dart';
import 'visibility/settings_visibility.dart';
import 'width/settings_width.dart';
      ...
      body: PageBody(
        ...
        child: ListView(
          ...
          padding: EdgeInsets.only(
            top: AppInsets.l + topPadding,
            bottom: AppInsets.l + bottomPadding + kToolbarHeight,
          ),
          children: <Widget>[
            Padding(
            ...
            Padding(
              ...
              child: PageIntro(
                introTop: const Text(
                  'Flexfold offers a large number of responsive behaviors '
                ...
                introBottom: const Text(
                  ...
                  'optional sidebar.\n'
                  '\n'
                  'The tooltips on the settings below show the Flexfold '
                  ...
                  'guide to the Flexfold API.',
                ),
                imageAssets: AppImages.route[SettingsScreen.route]!.toList(),
              ),
            ),
            const Divider(),
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: AppInsets.l),
              child:
                  Text('You can modify the width of the menu and sidebar. In '
            ...
            const Padding(
              ...
              child: Text(
                ...
                'destinations, but with a few more properties. Flexfold '
                'also has a custom theme FlexfoldThemeData, used to style the '
                'Flexfold scaffold and define values for less used properties.',
              ),
            ),
            const SizedBox(height: AppInsets.l / 2),
            const SettingsMenu(),
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: AppInsets.l),
              child: Text(
                'Flexfold app bars can be constructed with an optional '
            ...
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: AppInsets.l),
              child: Text(
                'These settings are not Flexfold settings, they are demo app '
                ...
                'you know the app. Flexfold allows your app to '
                ...
                'layout of Flexfold also changes with RTL directionality.',
              ),
            ),
            const SizedBox(height: AppInsets.l / 2),
