...
import '../../widgets/svg/logo.dart';
import '../../widgets/text/link_text_span.dart';
import '../../widgets/wrappers/animated_hide.dart';
import '../hide_bottom_on_scroll.dart';
import '../page_body.dart';
import 'copy_to_custom.dart';
import 'settings/compute_dark_theme_switch.dart';
import 'settings/dark_app_bar_switch.dart';
import 'settings/dark_colors_swap_switch.dart';
import 'settings/dark_level_slider.dart';
import 'settings/enabled_colors_switch.dart';
import 'settings/image_selector.dart';
import 'settings/light_app_bar_switch.dart';
import 'settings/light_colors_swap_switch.dart';
import 'settings/surface_style_switch.dart';
import 'settings/tab_bar_style_switch.dart';
import 'settings/theme_mode_switch.dart';
import 'settings/theme_popup_menu.dart';
import 'settings/theme_selector.dart';
import 'settings/tooltip_style_switch.dart';
...
class _ThemeScreenState extends ConsumerState<ThemeScreen>
  ...
  @override
  void initState() {
    debugPrint('ThemeScreen: initState()');
    super.initState();
    scrollController =
              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate(
                  <Widget>[
                    Padding(
                      padding:
                          const EdgeInsets.symmetric(horizontal: AppInsets.l),
                      child: PageHeader(
                          icon: icon,
                          heading: heading,
                    ...
                    Padding(
                      ...
                      child: PageIntro(
                        ...
                        imageAssets:
                            AppImages.route[ThemeScreen.route]!.toList(),
                      ),
                    ),
                    ...
                    Padding(
                      padding:
                          const EdgeInsets.symmetric(horizontal: AppInsets.l),
                      child:
                          Text('Theme Mode', style: theme.textTheme.headline5),
                    ),
                    const Padding(
                      padding: EdgeInsets.symmetric(horizontal: AppInsets.l),
                      child: Text(
                    ...
                    const Padding(
                      padding: EdgeInsetsDirectional.only(end: AppInsets.l),
              ...
              delegate: SliverChildListDelegate(
                <Widget>[
                  ...
                  const Padding(
                    padding: EdgeInsets.symmetric(horizontal: AppInsets.l),
                    child: Text(
                        'Common Material UI widgets using selected theme.'),
                  ),
                  //
                  // Show how Material widgets look with the theme
                  //
                  const Padding(
                    padding: EdgeInsets.symmetric(horizontal: AppInsets.m),
                    child: ThemeShowcase(),
                  ),
                  SizedBox(height: AppInsets.l + bottomPadding),
                ],
              ),
            ),
          ],
